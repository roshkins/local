  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved industry as @industry" do
        ...
        post :create, {:industry => { "title" => "invalid value" }}, valid_session
        assigns(:industry).should be_a_new(Industry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested industry" do
        ...
        Industry.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => industry.to_param, :industry => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the industry as @industry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Industry.any_instance.stub(:save).and_return(false)
        put :update, {:id => industry.to_param, :industry => { "title" => "invalid value" }}, valid_session
        assigns(:industry).should eq(industry)
      end
